...
```
# Was passiert bei einer Testentwicklung?
...
Über die hier verwendeten Funktionen können wir schon einige Aussagen treffen:
  ...
  2. Die "summary"-Funktion zeigt weiter: alle Items laden hinreichend gut auf diesem Faktor: die Zahlen unter F1 geben die Faktoreladungen an ( = wie sehr hängt die Zustimmung  zu einem Item von der zugrundeliegenden Eigenschaft ab) sind mindestens bei .44 - ab .32 ist es "gut genug".
