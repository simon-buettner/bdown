...
date: '2020-09-23'
slug: 02_2020-09-23-protestantische-arbeitsethik-2.en-us
categories: []
tags: []
keywords:
  - tech
...
# Protestantische Arbeitsethik 2: Was passiert bei der Testentwicklung?
...
Die nicht wenigen Zitationen und Arbeiten mit und um die PWES lasse ich hier außen vor, konzentriere mich stattdessen auf Variablen, die über die PWES hinaus im Openpsychometrics-Datensatz erhoben wurden. 
...
gmodel1_pwes_tipi <- mirt(dat_2, 1, "graded")
...
Da im vorliegenden Datensatz keine ganzen Fragebögen erhoben wurden, sondern nur 10 Adjektive ("I see myself as:" ADJEKTIV, 1 = Disagree strongly bis 7 = Agree strongly), die als Indikatoren für Persönlichkeitseigenschaften dienen, habe ich mir nicht die 10 Korrelationen mit diesen Antworten angeschaut.
...
Dann schaue ich mir wieder die Faktorladungen auf die Hauptdimension der Daten an - die Zahlen unter F1, um zu bestimmen, ob einzelne TIPI Items mit dem PWES Konstrukt zusammenhängen (ist ein leicht anderer Ansatz, als sich die 10 Korrelationen anzuschauen, macht aber im Grunde dasselbe).
...
Dass "Extraverted, enthusiastic", "Calm, emotionally stable" und "Anxious, easily upset" hoch auf der PWES Dimension laden, deutet an, dass Personen mit hohen PWES Werten eher emotional ausgeglichen sind, auch wenn das emotionale Befinden nicht in besonders hohen Maße mit der PWES zusammenhängt.
...
## Religion
Jetzt wird es endlich Zeit, die Ebene psychologischen Tests zu verlassen, um zu erfahren, ob es auch Zusammenhänge mit halbwegs harten Tatsachen der echten Welt zusammenhängt.
Die erste Fragestellung ist dabei schon die spannendste: hängt der PWES-Wert, der dezidiert eine protestantische Einstellung zu Arbeit erfasst, tatsächlich mit der angegebenen Religion der Teilnehmer zusammen?
...
Was wir dafür machen ist einfach: Wir testen die mittleren Unterschiede dieser Gruppen darauf, ob sie insgesamt überzufällig groß ausfallen, ob also "die" Religionen sich insgesamt unterscheiden (= erreichen alle Religionen in etwa die gleichen Werte oder nicht?), und dann noch, ob die einzelnen Religionen sich unterscheiden (= erreichen Protestanten höhere Werte als Katholiken?).
...
Wir vertrauen dem Entwickler des 'ggstatsplot'-Pakets, dass alles mit rechten Dingen zugeht, wenn wir für die 'ggbetweenstats'-Funktion die richtigen Eingaben machen.
...
Wir folgen hier der Einfachheit halber stupide den ausgegebenen p-Werten, die uns im Falle der Religion folgendes sagen:
  ...
  3. Dass sich Katholiken und Protestanten unterscheiden, wird nicht bekräftigt. Auch wenn die Richtung stimmt: nominell erreichen Protestanten einen höheren Score als Katholiken. Mit größeren Fallzahlen würde sich ggf. zeigen, dass hier ein echter Unterschied besteht, auch wenn nicht direkt zu erwarten wäre, dass dieser sehr groß ausfällt (sonst würde wir ihn vielleicht jetzt schon finden)
  
Meiner Ansicht nach ist das ein ziemlich gutes Ergebnis! 
...
Dafür sprechen meiner Meinung nach schon die ersten Ergebnisse zu Religion.
...
Ersteres ist natürlich relativ schwach: ob ich konservativ oder progressiv unterwegs bin ich möchte dass meine Partei gewinnt, also gehe ich zur Wahl.
Das Ergebnis also nicht so verwunderlich, die dahinterliegende Logik nicht bombenfest.

Für die Ausbildungshöhe könnte das Nullergebnis dahingehend interessanter sein, dass es durchaus so sein könnte, dass ein protestantischer Arbeitsethos einen zu höheren Ausbildungsabschlüssen antreibt.
...
Oder atheistischer gesehen: Man startet voll motiviert und wird dann im Laufe der Ausbildung entspannter.
Aber, das ist relativ müßige Spekulation.
