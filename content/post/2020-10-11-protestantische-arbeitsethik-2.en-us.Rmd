...
* Religion (Achtung das wird das Highlight!), wobei ich den Fokus auf diejenigen Religionszugehörigkeiten setze, für die genug Teilnehmer vorhanden sind: Agnostiker, Atheisten, Katholiken, Protestanten (es findet keine weitere Unterteilung der Protestanten statt. Es war nur möglich anzugeben, dass man Mormone oder "Anderer Christ" ist.)
...
Dann schaue ich mir wieder die Faktorladungen auf die Hauptdimension der Daten an - die Zahlen unter F1 -, um zu bestimmen, ob einzelne TIPI Items mit dem PWES Konstrukt zusammenhängen (ist ein anderer Ansatz als direkt die Korrelationen anzuschauen, macht aber im Grunde dasselbe).
...
An diese setzt man dann einige "Test-interne" Kriterien an, wie wir sie im ersten Blogpost zur PWES durchexerziert haben: die Items hängen sinnvoll miteinander zusammen; das statistische Modell passt; man misst halbwegs messgenau.
...
Um noch einen kleinen Ausblick zu geben und diesen zweiten Teil würdig so zu beenden, wie wir ihn begonnen haben - nämlich schwäbisch: bis zum nächsten Mal, wenn ich offenlege, was Mittelwertunterschiede *eigentlich* bedeuten, und Adele!
