...
Und einige interessante medizinische Effekte kann man sich auch zu Gemüte führen, dafür sei v.a. auf den schon oben angeführten Artikel von Meyer und Kollegen (2001) verwiesen.
...
Generell war schon sein Credo: Effektstärken müssen immer im Kontext des Forschungsgegenstands interpretiert werden. Für den Fall, dass das nicht möglich sein sollte, hat er einige allgemeine, zugegebenermaßen teils eigenartige, aber dafür wörtlich sehr anschauliche Benchmarks angegeben. 
Als solche setzt er die mittleren Körpergrößenunterschiede zwischen verschiedenen Altersstufen von Mädchen (das sind nicht die einzigen Benchmarks, die er zitiert, aber wir begnügen uns mit diesen):
...
**Richard, Bond und Stokes-Zota (2003) haben das für sozialpsychologische Effekte** und **Gignac und Szorodai (2016) für persönlichkeitspsychologische Effekte** nämlich schon für uns geleistet.
Die beiden Disziplinen unterscheiden sich häufig methodisch dahingehend, dass Sozialpsychologen experimentelle Manipulationen vergleichen (läuft häufig auf Mittelwertunterschiede hinaus) während Persönlichkeitspsychologen häufig untersuchen, wie bestimmte Persönlichkeitseigenschaften mit irgendeinem Kriterium (z.B. Berufserfolg) zusammenhängen.
Deswegen lassen sich beide eigentlich nicht so großartig vergleichen.
Ferner lassen sich experimentelle Untersuchungen untereinander schon schwer vergleichen: Wie soll man ein Experiment, in dem ein minimaler Unterschied zwischen den Experimentalgruppen betrachtet wird (z.B. vor der Klausur wird ein oder kein Apfel gevespert) mit einem, in dem die Experimentalgruppen sich stark unterscheiden (z.B. 4 Wochen lang tägliche 1-stündige Mentalcoachings vs. keine solche Coachings)?
Dass nur als kleines Denkmal dafür, dass auch wenn man in einer (Sub-)Disziplin selbst verbleibt, der Vergleich von Effektstärken eben nicht so einfach ist.

Interessanterweise sind die Effektstärken für sozial- und persönlichkeitspsychologische Untersuchungen sich dennoch recht ähnlich. 
...
Die ersten zwei Punkte werden wieder ein eigener Blogpost mit ShinyApp (und ich dachte doch tatsächlich, dass ich einen schönen kurzen Effektstärken-Blogpost über den Funder und Ozer Artikel schreibe!). 
Der letzte kratzt wieder an das Thema **Replizierbarkeit**, wofür ich nur eine Studie etwas genauer vorstellen möchte, die auch 4. etwas aufklärt. 
...
Für die Forscherkaste ist das noch etwas wichtiger, denn man möchte zum einen keine Karriere starten, in der man unechten Effekten nachrennt, und beim Vergleich seiner echten Effekte möchte man wissen, wie groß diese in Wahrheit sind, weniger, wie groß die „frisierten“ Effekte ausfallen – das ist im Zweifel auch sehr selbstwertdienlich und hilft auch bei der realistischen Studienplanung (Stichwort Poweranalyse). 
Um den Unterschied zwischen potenziell überschätzten und den „wahren“ Effekten zu untersuchen, haben **Schäfer und Schwarz (2019) traditionell veröffentlichte Effekte mit denen verglichen, die am Ende einer Studie mit durchloffenem Prä-Registrierungss-Prozess stehen**. 

Prä-registrierte Studien sollen mehr Transparenz der Forschungspraxis erlauben und könnten dieser etwas frischen wissenschaftlichen Lebenshauch einflößen.
Im Rahmen einer Prä-Registrierung meldet man z.B. erst in einem relativ detaillierten Protokoll an, was und wie man es untersuchen möchte. 
...
Da schon vorher klar ist, was gerechnet wird und man auf jeden Fall etwas veröffentlichen wird, erreicht man idealerweise eine geringere Verzerrung in dem, was schlussendlich veröffentlicht wird.
Ferner:

- Es werden nicht im Nachhinein, wenn die Ergebnisse schon feststehen, Hypothesen gebildet, die dann – Oh Wunder – bestätigt werden (ich kann es gerade leider nicht zitieren, aber einige Forscher haben einmal untersucht, wie oft Psychologen ihre Hypothesen in veröffentlichten Studien bestätigt fanden. Das war so häufig der Fall, dass man sich beinahe fragen könnte, wieso man die Studien überhaupt noch durchführt, wenn Psychologen doch vorher immer schon wissen, was bei ihrer Untersuchung rauskommen wird). 
...
- Und wenn etwas nicht klappt, dann wandert die missglückte Untersuchung nicht in die Schublade des Scheiterns und man beginnt anschließend das Roulettespiel von neuem mit minimalen Anpassungen und hofft, dass es dann ganz bestimmt klappt, denn man hat ja schlaue Sachen angepasst (wieder: hier steckt nicht unbedingt eine böse Absicht hinter der allgemeinen Praxis und sie ist dennoch höchst problematisch!). 
...
- Camerer und Kollegen (2018) untersuchten 21 zwischen 2010 und 2015 in *Nature* und *Science* (sehr prestigeträchtige Journals) veröffentlichte sozialwissenschaftlichte Experimente auf ihre Replizierbarkeit: 
  - Von den mit deutlich größeren Fallzahlen replizierten Experimenten wurden in 13 Fällen (= 62%) statistisch signifikante Effekte in die gleiche Richtung wie in den originalen Experimenten gefunden – was als deren Hauptkriterium galt, um von „erfolgreichen Replizierungen“ zu sprechen. 
  - Die Effektstärken nicht-replizierter und replizierter Studien fielen im Schnitt halb so hoch aus wie im Original, mittleres *r* = 0.249 zu mittleres *r* = 0.460. Die Effektstärken der erfolgreich replizierten Studien erreichte ca. 75% der originalen Effektstärken (was wiederum ganz gut ist).
  - Außerdem konnte gezeigt werden, dass auf unterschiedliche Weise gesammelte Meinungen dazu, welche Effekte sich wohl replizieren ließen, eine recht gute Vorhersage dafür lieferten, welche Effekte tatsächlich replizierbar waren. Die Forschercommunity scheint also die Replizierbarkeit bzw. Robustheit von Effekten relativ gut einschätzen zu können (aber: da nur 21 Effekte untersucht wurden, gilt das natürlich nicht uneingeschränkt).
...
Hat den schönen Nebeneffekt, dass wenn man beides findet, umso mehr Grund zur epistemischen Freude besteht. 

Aber zurück zur Studie. 
Schäfer und Schwarz (2019) haben in 9 Kategorien psychologischer Forschung jeweils zufällig 100 Effekte aus traditionell durchgeführten Studien gezogen (also 900 traditionelle Effekte) und wollten diese mit auf die gleiche Weise gezogenen Effekte aus prä-registrierten Studien vergleichen. 
...
Das bedeutsamste Ergebnis: wie erwartet, fallen die Effektstärken in der Prä-Regristrierungscharge kleiner aus. 
Bei den traditionellen Studien wurde ein Median-Effekt von *r* = 0.36 gefunden, bei den Prä-Registrierung Studien mit *r* = 0.16 von nur etwas weniger als der Hälfte. 

Bevor wir zu einigen der restlichen Ergebnisse kommen, müssen wir hier natürlich erst mal einhaken. 
Das Ergebnis selbst erfüllt so ziemlich die negativen Erwartungen meines inneren Zweiflers: Je strikter und weniger verzerrt die Studie durchgeführt wird, desto geringer die Effektstärke. 
...
Vielleicht auch in spezifischen Subdisziplinen oder bei den Effekten, die es eben noch nicht in die zugrunde gelegten Meta-Analysen geschafft haben. 
...
Der Vollständigkeit halber: Die geringeren Effektstärken der Prä-Registrierungsstudien müssen nicht auf fragwürdige Forschungspraktiken allein zurückgeführt werden, Schäfer und Schwarz berichten z.B., dass nicht unwahrscheinlich ist, dass in diesen Studien vielleicht besonders solche Effekte untersucht werden, die eher klein oder etwas wackelig sind, bei denen man also ggf. Pech hat und anders keine Publikation erreicht. 
Forscher, die dann ihre Risiken minimieren wollen, stecken möglicherweise also einfach mehr Aufwand in die Vorarbeit einer Prä-Registrierung, was für die Forschercommunity super ist, denn dann werden auch wieder mehr Nullergebnisse unproblematisch veröffentlicht. 
Es findet vielleicht also auch eine Selbst-Selektion statt: in prä-registrierten Studien werden tendenziell kleinere Effekte untersucht.
...
![Effektstärken je Subdisziplin](/img/Effektstärken_je_Subdisziplin.png){width=90%}
...
Wer wissen will, ob ein sozialpsychologischer Effekt groß oder klein ist, sollte den Vergleich mit Biopsychostudien nicht aufnehmen. 
...
Fraley, R. C., & Marks, M. J. (2007). The null hypothesis significance testing debate and its implications for personal-ity research. In R. W. Robins, R. C. Fraley, & R. F. Krueger (Eds.), *Handbook of research methods in personality psychology* (pp. 149–169). New York, NY: Guilford Präss.
